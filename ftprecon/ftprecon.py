...
outfile = "/root/Desktop/results/exam/" + ip_address + "_ftprecon.txt"
f = open(outfile, "w")
f.write(results)
f.close

print "INFO: Performing hydra ftp scan against " + ip_address 
HYDRA = "hydra -L /root/Desktop/wordlists/userlist -P /root/Desktop/wordlists/offsecpass -f -o /root/Desktop/results/%s_ftphydra.txt -u %s -s %s ftp" % (ip_address, ip_address, port)
